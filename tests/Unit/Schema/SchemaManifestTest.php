...
namespace Glueful\Extensions\Commerce\Tests\Unit\Schema;
...
final class SchemaManifestTest extends TestCase
{
    ...
    public function testVerifierClassConformsToTheManifestContract(): void
    {
        ...
        self::assertSame('glueful/commerce', (new $class())->source());
    }

    public function testVerifierCoversEveryRecursivelyDiscoveredMigration(): void
    {
        $mapped = (new CommerceSchemaVerifier())->migrationBasenames();
    ...
    {
        $g = $this->manifest();
        $candidates = ['glueful/commerce' => new \Glueful\Extensions\ExtensionCandidate(
        ...
        self::assertSame([], $result->errors, 'commerce must resolve enabled-alone');
    }
